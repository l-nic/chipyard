...
def launch_switch(num_sims, current_run):
    with cd("chipyard/software/local_firesim/switch"):
        run("script -f -c \'sudo ./switch 6405 10 100 8192 8182\' ../logs/" + current_run + "switchlog > /dev/null")
